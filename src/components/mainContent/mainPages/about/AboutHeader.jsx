    ...
    <div className={s.about_header_wrap}>
      <div className={s.header_text_block}>
        ...
        <p className={`${s.header_text} text-muted`}>
          ...
          including{" "}
          <a href="https://www.sparkleappz.com/android-app-development/">
            Mobile Application Development
          </a>{" "}
          ,
          <a href="https://www.sparkleappz.com/digital-marketing-services/">
            {" "}
            SEO
          </a>
          ,
          <a href="https://www.sparkleappz.com/unity-3d-game-development/">
            {" "}
            Unity 3D
          </a>
          , and{" "}
          <a href="https://www.sparkleappz.com/website-development-services/">
            {" "}
      ...
      <div className={s.header_image_block}>
        <img
          src="https://i0.wp.com/www.sparkleappz.com/wp-content/uploads/2020/01/slider_image.png?fit=745%2C722&ssl=1"
          alt=""
        />
      </div>
    </div>
