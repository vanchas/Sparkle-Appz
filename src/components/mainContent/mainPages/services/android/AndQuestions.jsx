          ...
          <div className="card">
            <div className={`${s.card_header} card-header`} id="headingOne">
              <h5 className="mb-0">
                ...
                >
                  <span>01</span> - Which Technologies do you guys work on?
                </button>
              </h5>
            </div>
            <div
            ...
            >
              <div className="card-body text-muted">
                We work on all latest and trending technologies which includes
                both web and mobile app development. Like Android Native and
                other technologies.
              </div>
            </div>
          </div>
          <div className="card">
            <div className={`${s.card_header} card-header`} id="headingTwo">
              <h5 className="mb-0">
                ...
                >
                  <span>02</span> - Which platform shold we target iOS / Android
                  or both?
                </button>
              </h5>
            </div>
